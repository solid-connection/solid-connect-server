...
class ScoreServiceTest {
    ...
    void GPA_점수를_등록한다() {
        ...
        given(s3Service.uploadFile(file, UploadType.GPA)).willReturn(new UploadedFileUrlResponse(fileUrl));
    ...
    void 어학_시험_점수를_등록한다() {
        ...
        MockMultipartFile file = createFile();
        String fileUrl = "/gpa-report.pdf";
        given(s3Service.uploadFile(file, UploadType.LANGUAGE_TEST)).willReturn(new UploadedFileUrlResponse(fileUrl));
