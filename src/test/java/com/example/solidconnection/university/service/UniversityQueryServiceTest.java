...
class UniversityQueryServiceTest {
    ...
    void 대학_상세정보를_정상_조회한다() {
        // given
        UnivApplyInfo 괌대학_A_지원_정보 = universityInfoForApplyFixture.괌대학_A_지원_정보();
    ...
    void 전체_대학을_조회한다() {
        // given
        UnivApplyInfo 괌대학_A_지원_정보 = universityInfoForApplyFixture.괌대학_A_지원_정보();
        UnivApplyInfo 괌대학_B_지원_정보 = universityInfoForApplyFixture.괌대학_B_지원_정보();
        UnivApplyInfo 네바다주립대학_라스베이거스_지원_정보 = universityInfoForApplyFixture.네바다주립대학_라스베이거스_지원_정보();
        UnivApplyInfo 서던덴마크대학교_지원_정보 = universityInfoForApplyFixture.서던덴마크대학교_지원_정보();
        UnivApplyInfo 그라츠대학_지원_정보 = universityInfoForApplyFixture.그라츠대학_지원_정보();
        UnivApplyInfo 메이지대학_지원_정보 = universityInfoForApplyFixture.메이지대학_지원_정보();
