...
VALUES ('2024-1', 1, 2, 1, 'IRRELEVANT', 'HOME_UNIVERSITY_PAYMENT', '파견대학에 지원하는 전공과 본교 전공이 일치해야함', NULL,
       ...
       ('2024-1', 3, 2, 5, 'IRRELEVANT', 'OVERSEAS_UNIVERSITY_PAYMENT', '- 지원가능전공: 공학계열 관련 전공자<br>- 파견대학에 지원하는 전공과 본교 전공이 일치해야함',
       ...
       ('2024-1', 7, 2, 5, 'IRRELEVANT', 'OVERSEAS_UNIVERSITY_PAYMENT', '타전공 지원 및 수강 가능<br>- MECO, CAEL, LAWS unit 수강 여석 제한 있음',
        NULL,
