...
INSERT INTO university_info_for_apply(term_id, university_id, korean_name, semester_requirement, student_capacity,
...
VALUES (1, 1, '괌대학(A형)', 2, 1, 'IRRELEVANT', 'HOME_UNIVERSITY_PAYMENT', '파견대학에 지원하는 전공과 본교 전공이 일치해야함', NULL,
        '외국어 성적 유효기간이 파견대학의 지원시까지 유효해야함', NULL, NULL, NULL),
       (1, 1, '괌대학(B형)', 2, 2, 'IRRELEVANT', 'OVERSEAS_UNIVERSITY_PAYMENT', '파견대학에 지원하는 전공과 본교 전공이 일치해야함', NULL,
        '외국어 성적 유효기간이 파견대학의 지원시까지 유효해야함', NULL, NULL, '등록금 관련 정보: https://www.uog.edu/financial-aid/cost-to-attend'),
       (1, 2, '네바다주립대학 라스베이거스(B형)', 2, 5, 'IRRELEVANT', 'OVERSEAS_UNIVERSITY_PAYMENT',
       ...
       (1, 3, '메모리얼 대학 세인트존스(A형)', 2, 4, 'ONE_SEMESTER', 'HOME_UNIVERSITY_PAYMENT',
        ...
        NULL, NULL, NULL),
       (1, 3, '메모리얼 대학 세인트존스(B형)', 2, 5, 'IRRELEVANT', 'OVERSEAS_UNIVERSITY_PAYMENT',
        '타전공 지원 및 수강 가능 <br>- 지원불가능전공: Medicine, Pharmacy, Social work, Nursing<br>- Computer Science, Music 지원 제한적',
        NULL,
        '영어 점수는 다음의 세부영역 점수를 각각 만족해야함<br>  - TOEFL iBT : 읽기/쓰기 20점, 듣기/말하기 17점 이상<br>  - IELTS : 모든 영역에서 6.0 이상<br> - 외국어 성적 유효기간이 파견대학의 학기 시작하는 날까지 유효해야함 ',
        NULL, NULL, '국제학생 등록금 적용 (학점당 $2,080)'),
       (1, 4, '서던퀸스랜드대학(B형)', 2, 5, 'ONE_SEMESTER', 'OVERSEAS_UNIVERSITY_PAYMENT',
       ...
       (1, 5, '시드니대학', 2, 5, 'IRRELEVANT', 'OVERSEAS_UNIVERSITY_PAYMENT',
       ...
       (1, 6, '커틴대학(A형)', 2, 3, 'ONE_SEMESTER', 'HOME_UNIVERSITY_PAYMENT',
       ...
       (1, 7, '서던덴마크대학교', 4, 2, 'IRRELEVANT', 'HOME_UNIVERSITY_PAYMENT',
       ...
       (1, 8, '코펜하겐 IT대학', 2, 2, 'ONE_SEMESTER', 'HOME_UNIVERSITY_PAYMENT',
       ...
       (1, 9, '노이울름 대학', 2, 3, 'IRRELEVANT', 'HOME_UNIVERSITY_PAYMENT', '타전공 지원 및 수강 가능', NULL,
        ...
        NULL, NULL, NULL),
       (1, 10, '헐대학', 4, 3, 'ONE_SEMESTER', 'HOME_UNIVERSITY_PAYMENT',
       ...
       (1, 11, '그라츠 대학', 3, 2, 'IRRELEVANT', 'HOME_UNIVERSITY_PAYMENT', '-주전공 혹은 제2전공(혹은 연계전공과) 유관학과여아 함',
        '선발인원 중 차순위 합격자는 학기제한(1개 학기)이 있을 수 있음', NULL, NULL, '학교인근 외부 숙소는 있지만, 외부업체운영숙소라 대학관할아님', NULL),
       (1, 12, '그라츠공과대학', 2, 2, 'IRRELEVANT', 'HOME_UNIVERSITY_PAYMENT', '-주전공 혹은 제2전공(혹은 연계전공과) 유관학과여아 함',
        ...
        NULL),
       (1, 13, '린츠 카톨릭 대학교', 3, 2, 'ONE_SEMESTER', 'HOME_UNIVERSITY_PAYMENT',
       ...
       (1, 14, '빈 공과대학교', 3, 2, 'IRRELEVANT', 'HOME_UNIVERSITY_PAYMENT',
       ...
       (1, 15, 'IPSA', 4, 3, 'IRRELEVANT', 'HOME_UNIVERSITY_PAYMENT',
       ...
       (1, 16, '메이지대학', 2, 3, 'IRRELEVANT', 'HOME_UNIVERSITY_PAYMENT',
       ...
       (1, 17, '바이카여자대학', 2, 1, 'IRRELEVANT', NULL,
       ...
       (1, 18, '분쿄가쿠인대학', 2, 3, 'ONE_YEAR', 'HOME_UNIVERSITY_PAYMENT', NULL, NULL, NULL, NULL,
