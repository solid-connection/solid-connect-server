...
(
    ...
    CONSTRAINT uk_term_name UNIQUE
(
    name
)
    );
...
INSERT
IGNORE INTO term (name, is_current)
...
VALUES ('2026-1', TRUE) ON DUPLICATE KEY
...
SET
@drop_fk1 = IFNULL(@drop_fk1, 'SELECT 1');
...
SET
@drop_fk2 = IFNULL(@drop_fk2, 'SELECT 1');
...
SET
@drop_fk3 = IFNULL(@drop_fk3, 'SELECT 1');
...
SET
@drop_fk4 = IFNULL(@drop_fk4, 'SELECT 1');
