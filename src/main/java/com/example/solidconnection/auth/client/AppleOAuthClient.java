...
public class AppleOAuthClient {
    ...
    public AppleUserInfoDto processOAuth(String code) {
        ...
        return new AppleUserInfoDto(parseEmailFromToken(idToken));
    }
    ...
    private String parseEmailFromToken(String idToken) {
        try {
            return Jwts.parser()
            ...
            throw new CustomException(APPLE_ID_TOKEN_MISSING_EMAIL);
        }
    }
}
